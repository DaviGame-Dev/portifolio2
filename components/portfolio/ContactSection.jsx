            ...
            <form onSubmit={handleSubmit} className="relative space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-[#0A0A0F] border-gray-700 focus:border-purple-500 text-white placeholder:text-gray-500 h-12"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-[#0A0A0F] border-gray-700 focus:border-cyan-500 text-white placeholder:text-gray-500 h-12"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  required
                  rows={6}
                  className="bg-[#0A0A0F] border-gray-700 focus:border-pink-500 text-white placeholder:text-gray-500 resize-none"
                />
              </div>
